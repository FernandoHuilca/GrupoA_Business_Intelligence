...
<img width="405" height="547" alt="image" src="https://github.com/user-attachments/assets/3e58c81b-3c53-438f-ab6b-89675f3da54d" /> <br><br>
...
<img width="659" height="499" alt="image" src="https://github.com/user-attachments/assets/dd17ef23-59f5-4397-9a8c-11715fe5d466" /> <br><br>

En la pestaña *Table Design*, se asignó el nombre correspondiente a la tabla creada; en este caso, 'dim_category'.

<img width="1070" height="524" alt="image" src="https://github.com/user-attachments/assets/9bf701c9-8876-410f-8184-7c4610ac0fc2" /> <br><br>
...
Los datos del archivo "Tabla_Desnormalizada_Ventas.csv" se trasladaron a una tabla en una base de datos.

Para ello, primero se creó la tabla "sales" con cada columna del archivo como un campo en la tabla con su respectivo tipo de dato.

<img width="810" height="726" alt="image" src="https://github.com/user-attachments/assets/a7bf639a-8950-4230-8262-d5364f8e57c4" /> <br><br>

Luego, haciendo clic derecho en la tabla "sales", se pulsó la opción "Import/Export Data". En la pestaña "General", se obtuvo el archivo "Tabla_Desnormalizada_Ventas.csv", especificando su format y el tipo de encoding. 

<img width="872" height="676" alt="image" src="https://github.com/user-attachments/assets/8ada7403-579a-498b-a517-5350ac012f30" /> <br><br>

En la pestaña "Options", se especificó que sí tenía encabezado el archivo, se estableció el delimitador de campos como punto y coma (;). El resto de opciones se dejaron por defecto.

<img width="874" height="672" alt="image" src="https://github.com/user-attachments/assets/7c0fa71c-b142-489b-bc54-a39f3b8a9c36" /> <br><br>

En la pestaña "Columns" se verificaron que las columnas a importar sean las correctas y se pulsó en el botón "Ok".

<img width="871" height="678" alt="image" src="https://github.com/user-attachments/assets/a4bdb480-f906-4e7a-87e8-aff0ee94b6a6" /> <br><br>

Se ejecutó una sentencia SQL para verificar que los datos se hayan importado correctamente a la tabla "sales".

<img width="1388" height="719" alt="image" src="https://github.com/user-attachments/assets/b536f1c2-8ce3-42e0-80c7-4f5b7ebdc495" /> <br><br>

Luego, se crearon las tablas de dimensiones dim_product, dim_customer y dim_date, y la tabla de hechos fact_sale. Para esto, se hizo uso de sentencias SQL para crear cada tabla con sus respectivos campos y tipos de datos (Primero se crearon primero las tablas de dimensiones y luego la tabla de hechos, porque esta última hace referencia a las anteriores tablas). 
...
<img width="676" height="543" alt="image" src="https://github.com/user-attachments/assets/5d000a1c-ca76-452f-a542-e0467cfbd761" /> <br><br>

Después, los datos de la tabla original desnormalizada (sales) se insertaron en cada una de las tablas pertenecientes al modelo estrella.
